...
class TLDetector(object):
    ...
    def get_light_state(self, light):
        ...
        if self.RUNNING_MODE == 'SIMULATION':
            ...
            #Get classification
            est_light = self.light_classifier.get_classification(cv_image)
            #print('Light (ground truth): {}     Light (estimated): {}'.format(light.state, est_light))
            return est_light
            #return light.state 
    ...
    def process_traffic_lights(self):
        ...
        if (closest_light):
            ...
            #print('Closes light at wp_idx {}, distance {}, light {}'.format(line_wp_idx, self.traffic_ego_dist, closest_light.state))
